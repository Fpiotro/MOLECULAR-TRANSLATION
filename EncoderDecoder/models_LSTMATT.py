...
# ====================================================
# Encoder / Attention / DecoderWithAttention
# ====================================================
class Encoder(nn.Module):
    ...
    def load_weights(self, file_path):
        """
        Allow to load weights.

        :param file_path: Path where the weights are stored
        """
        pretrained_weights = torch.load(file_path, map_location=device)
